...
moodle_add_new_user_path_title = 'SQA: Administration: Users: Accounts: Add a new user'
...
admin_username = 'raziehmokhtarnameh'
...
description = f'User added by {admin_username} via Python Selenium Authomated script on {datetime.datetime.now()}' # fake.sentence(nb_words=100)
...
# print(new_username, new_password, first_name, last_name)
#--------------------------------------------------------